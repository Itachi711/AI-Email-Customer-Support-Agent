...
class Workflow:
    def __init__(self, nodes=None):
        ...
        workflow.add_node("discard_unsendable_email", nodes.discard_unsendable_email)
        ...
        workflow.add_edge("discard_unsendable_email", "is_email_inbox_empty")
